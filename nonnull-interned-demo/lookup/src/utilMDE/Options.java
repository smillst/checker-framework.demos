...
public class Options {
  ...
  private class OptionInfo {
    ...
    OptionInfo (Field field, Option option, Object obj) {
      ...
      @Nullable Object default_obj = null;
      try {
      ...
      if (gen_type instanceof ParameterizedType) {
        ...
        if (!raw_type.equals ((@NonNull Class) List.class))  // @NE x.class
        ...
        this.base_type = (@NonNull Class<@NonNull ?>) pt.getActualTypeArguments()[0]; // @NE class-cast
      ...
      if (!base_type.isPrimitive() && !base_type.isEnum()) {
        try {
          if (base_type == Pattern.class) {
            ...
            constructor = base_type.getConstructor ((@NonNull Class) String.class); //@NE class-cast
          }
        } catch (Exception e) {
    ...
    for (Object obj : classes) {
      ...
      if (obj instanceof Class) {
        ...
        for (Field f : fields) {
          ...
          @Nullable Option option = f.getAnnotation ((@NonNull Class<@NonNull Option>) Option.class); // @NE x.class
          if (option == null)
            continue;
  ...
  public String[] parse (String[] args) throws ArgException {
    ...
    for (int ii = 0; ii < args.length; ii++) {
      ...
      if (arg.startsWith ("--") && !ignore_options) {
        ...
        String arg_name = arg;
        @Nullable String arg_value = null;
        if (eq_pos > 0) {
      ...
      if (type.isPrimitive()) {
        ...
        try {
          if (oi.constructor != null)
            ...
            assert oi.factory != null; // @NE app-inv
  ...
  public String settings () {
    ...
    for (OptionInfo oi : options) {
      ...
      try {
        use += (@NonNull String) oi.field.get (oi.obj); // @NE string+
      } catch (Exception e) {
  ...
  public void jdoc (RootDoc doc) {
    ...
    @Nullable ClassDoc main = find_class_doc (doc, main_class);
    if (main == null) {
  ...
  private static String[] parse_option (String val) {
    ...
    @Nullable String short_name = null;
    @Nullable String type_name = null;
